...
import { slugify, SortingByDate } from "../../../../../utils";
...
const MetaDataTwo = ({ metaData, allPost }) => {
	...
	// const previousPost = allPost.filter(post => DateTime.fromFormat(post.date, "LLL dd yyyy").ts > currentPostdateFormat.ts);
	
	// console.log(previousPost)


  return (
    <div className="banner banner__single-post banner__single-type-two" style={{backgroundImage: `url(${metaData.featureImg})`}}>
