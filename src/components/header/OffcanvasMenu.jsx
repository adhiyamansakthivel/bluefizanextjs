...
const OffcanvasMenu = ({ofcshow, ofcHandleClose, action = '/search'}) => {
        ...
        <Offcanvas show={ofcshow} onHide={ofcHandleClose} placement="end" className="offcanvas-menu">
            ...
            <div className="side-nav">
                <div className="side-nav-inner nicescroll-container">
                    <form onSubmit={handleSubmit} className="side-nav-search-form">
                    <div className="form-group search-field">
                        <input type="text" className="search-field" name="post" value={query} onChange={handleParam(setQuery)} placeholder="Search..." />
